...
var test = ['Number', 'Ethanol','2-propanol','Acetone','Methylene chloride','n-Hexane','Pentane, 2,4-dimethyl','2-Butanone','Ethyl Acetate'
...
for(var i = 1; i < 46; i++){
if(value[j] == 0 && value2[j] == 0 && value3[j] == 0 && value4[j] == 0 && value5[j] == 0 && value6[j] == 0){
  test.splice(j,1);
  value.splice(j,1);
  value2.splice(j,1);
  value3.splice(j,1);
...
for(var i = 1; i < 46; i++){
if(value[j] == 0 && value2[j] == 0 && value3[j] == 0 && value4[j] == 0 && value5[j] == 0 && value6[j] == 0 && value7[j] == 0 && value8[j] == 0 && value9[j] == 0 && value10[j] == 0){
  test.splice(j,1);
  value.splice(j,1);
  value2.splice(j,1);
  value3.splice(j,1);
...
var data = google.visualization.arrayToDataTable([
  test,value,value2,value3,value4,value5,value6,value7,value8,value9,value10
...
function valueMatting(area_Name){
  ...
  if(area_Name == '부산 연안'){
      ...
      //기초 (소숫점 첫째자리로 통일)
      suon = [24.4,23.7,23.7,24.7,24.7,24.6,25.1,24.9,23.4,23.4];
      yeombun = [31.7,31.4,31.4,31.6,31.5,31.3,31.4,31.5,31.6,31.6];
      ph = [8.2,8.6,8.6,8.4,8.4,8.4,8.4,8.2,8.6,8.6];
      Do = [7.4,7.7,7.2,7.3,7.6,7.6,7.2,8.3,7.4,7.3];
